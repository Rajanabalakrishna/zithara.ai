...
class _WeatherScreenState extends ConsumerState<WeatherScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final locationState = ref.read(locationPermissionControllerProvider);

      if (locationState.status == LocationPermissionStatus.granted) {
